 function fname_check()
  {
    ...
    if (fn_check) 
    {
        document.getElementById("errorfname").innerHTML="Name right";
        return true;
    }
    else
    {
        document.getElementById("errorfname").innerHTML="First Name must be Alphabets!should not contain numbers and symbols.";
        return false;
    }
  }
  function lname_check()
  {
    ...
    if (fn_check) 
    {
        document.getElementById("errorlname").innerHTML="Name right";
        return true;
    }
    else
    {
        document.getElementById("errorlname").innerHTML="Last Name must be Alphabets!should not contain numbers and symbols.";
        return false;
    }
  }
  function email_check()
  {
    ...
    if (em_check) 
    {
        document.getElementById("erroremail").innerHTML="Right";
        return true;
    }
    else
    {
  ...
  function age_check()
  {
    ...
    if (age_check) 
    {
        document.getElementById("errorage").innerHTML="Ok";
        return true;
    }
    else
    {
  ...
  function pass_check()
  {
    ...
    if (pass_check) 
    {
        document.getElementById("errorpass").innerHTML="passwared correct ";
        return true;
    }
    else
    {
